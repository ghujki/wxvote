...
require_once "AjaxTrait.php";
require_once APPPATH."third_party/symfony/css-selector/CssSelectorConverter.php";
require_once "Node.php";
require_once "Support/NodeCollection.php";
class Document
{
    use AjaxTrait;
    ...
    public function __construct($html,$encode = "UTF8")
    {
        libxml_use_internal_errors(true);

        $this->dom = new \DOMDocument();
        $this->dom->loadHtml($html);
        $this->dom->encoding = $encode;
